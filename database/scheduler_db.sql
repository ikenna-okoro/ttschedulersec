...
ALTER TABLE `student_meta`
  ADD CONSTRAINT `student_meta_sch` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;

-- Constraints for table `auth_users`
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_sch` FOREIGN KEY (`name`) REFERENCES `auth_users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
