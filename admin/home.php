...
<?php
$sched_query = $conn->query("SELECT a.*,s.name FROM `appointments` a inner join `students` s on a.student_id = s.id");
...
<script>
    $(function(){
        ...
        var calendar = new Calendar(calendarEl, {
                        ...
                        eventClick:(info)=>{
                            uni_modal("Details Details of Schedule","appointments/view_details.php?id="+info.event.id)
                        },
                        editable  : false,
                        selectable: true,
