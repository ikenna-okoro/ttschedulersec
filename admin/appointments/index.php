        ...
        <div class="container-fluid">
			...
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT s.*,a.date_sched,a.status,a.id as aid from `students` s inner join `appointments` a on s.id = a.student_id  order by unix_timestamp(a.date_sched) desc ");
